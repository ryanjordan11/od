...
export const ru: Dict = {
  ...
  'chat.amrCard.switchBody': 'Переключитесь на официальный сервис моделей AMR от OneHub Design — без настройки API-ключа. После входа, авторизации и пополнения это выполнение будет автоматически повторено.',
  ...
  'settings.welcomeTitle': 'Добро пожаловать в OneHub Design',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Начать с краткого описания',
  'settings.onboardingCreateBody': 'Опишите сайт, приложение, презентацию, изображение или видео, которое вам нужно. OneHub Design создаст проект и сохранит возможность редактирования работы.',
  ...
  'settings.onboardingMemoryCalloutBody': 'Эти ответы формируют основу вашего профиля Памяти. OneHub Design использует его в каждой задаче и продолжает учиться, пока вы работаете.',
  ...
  'settings.onboardingCloudTitle': 'Войти в OneHub Design',
  'settings.onboardingCloudBody': 'Войдите и сразу начните создавать с облачным ИИ — без сложных настроек.',
  'settings.onboardingCloudSignIn': 'Войти в OneHub Design Cloud',
  ...
  'settings.onboardingGateTooltipAmr': 'Следующие шаги выполняются на ИИ — войдите в OneHub Design AMR, чтобы продолжить.',
  ...
  'settings.agentInstall.pathHint': 'Если вы установили CLI через npm или Homebrew, но она всё ещё отмечена как не установленная, убедитесь, что bin-каталог инструмента есть в PATH, который наследует daemon OneHub Design (в macOS PATH у Terminal и GUI-приложений может отличаться). См. QUICKSTART.md (раздел "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Откройте Установить или Документация для нужного агента.',
  'settings.agentInstall.stepAuth': 'Пройдите аутентификацию в CLI поставщика (вход или добавление API-ключей), затем вернитесь в OneHub Design.',
  ...
  'settings.mcpServerHint': 'Откройте OneHub Design как MCP-сервер для вашего кодинг-агента.',
  ...
  'settings.privacyHint': 'Какие данные передаются команде OneHub Design',
  'settings.privacyConsentKicker': 'Помогите нам улучшить OneHub Design',
  'settings.privacyConsentLead': 'OneHub Design может передавать данные об использовании нашей команде, чтобы помочь нам стать лучше. Сюда входят:',
  ...
  'settings.mcpHint': 'Позвольте агентам для кода (Cursor, Claude Code, VS Code…) напрямую читать ваши проекты OneHub Design.',
  'settings.mcpDaemonError': 'Не удалось подключиться к локальному демону для определения путей установки ({error}). Убедитесь, что OneHub Design запущен, затем снова откройте эту панель.',
  ...
  'settings.mcpCapabilityDefault': 'По умолчанию использовать проект и файл, открытые в OneHub Design, чтобы можно было сказать «собери это в моём приложении», не уточняя, о каком дизайне идёт речь.',
  'settings.mcpRunningNote': 'Для успешного выполнения вызовов инструментов MCP необходимо, чтобы OneHub Design был запущен. Если вы запустили своего агента для кодинга до открытия OneHub Design, перезапустите агент, чтобы он мог подключиться к работающему демону.',
  ...
  'entry.discordAria': 'Присоединиться к Discord-сообществу OneHub Design',
  'entry.discordAriaWithOnline': 'Присоединиться к Discord-сообществу OneHub Design — {online}',
  ...
  'homeHero.chip.createPluginHint': 'Создайте многоразовый плагин OneHub Design и добавьте его в раздел «Мои плагины».',
  ...
  'handoff.promptIntro': 'Продолжить из этой локальной папки проекта OneHub Design:',
  ...
  'pluginsHome.subtitle': 'Готовые рабочие процессы OneHub Design, входящие в состав этой среды выполнения. Выберите один, чтобы загрузить стартовый запрос, или просмотрите реестр для дополнительных вариантов.',
  ...
  'pluginsHome.emptyCatalog': 'Каталог пуст. Встроенные плагины поставляются вместе с OneHub Design и должны появляться здесь автоматически — если проблема не исчезает, попробуйте перезапустить демон.',
  ...
  'pluginCard.contributeAria': 'Внести {title} в OneHub Design',
  'pluginCard.contributeTitle': 'Внести плагин в OneHub Design через pull request',
  ...
  'integrations.lede': 'Подключайте внешние системы, добавляйте инструменты MCP в цикл работы вашего агента и используйте OneHub Design из других IDE, скриптов и средств автоматизации.',
  ...
  'mcpClient.daemonError': 'Не удалось подключиться к локальному демону. Убедитесь, что OneHub Design запущен, затем снова откройте эту панель.',
  'mcpClient.saveFailed': 'Не удалось сохранить. Убедитесь, что демон запущен, и повторите попытку.',
  'useEverywhere.modalAria': 'Используйте OneHub Design везде',
  'useEverywhere.modalTitle': 'Используйте OneHub Design везде',
  'useEverywhere.modalSubtitle': 'Подключайте OneHub Design к любой IDE, агенту или скрипту — CLI, HTTP, MCP и Skills. Используйте «Copy guide for an agent» и вставьте в Claude Code, Codex, Cursor, openclaw или hermes, чтобы настроить всё.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — готовые к использованию пакеты `SKILL.md` (совместимые с Claude), которые любой агент, уже находящийся в вашем PATH, может вызвать вообще без OneHub Design.',
  ...
  'useEverywhere.section.cli.heading': 'Управляйте OneHub Design из любой оболочки',
  ...
  'useEverywhere.section.mcp.heading': 'Предоставьте OneHub Design как сервер MCP любому кодовому Agent',
  'useEverywhere.section.mcp.intro': 'OneHub Design поставляется с сервером Model Context Protocol (`od mcp`), который позволяет любому клиенту с поддержкой MCP — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — обнаруживать инструменты OneHub Design (получать список навыков, отображать предпросмотры, генерировать медиа, запускать плагины) без ручного вызова через shell. Демон публикует готовый к вставке фрагмент установки через `GET /api/mcp/install-info` для каждого основного клиента.',
  ...
  'useEverywhere.section.mcp.footer': 'В приложении OneHub Design откройте Settings → Integrations, чтобы скопировать команду установки для конкретного клиента (Cursor, Claude Code, Antigravity, VS Code) вместо ручного редактирования JSON.',
  ...
  'useEverywhere.section.skills.heading': 'Готовые к использованию Skills для любого агента — даже без запущенного OneHub Design',
  'useEverywhere.section.skills.intro': 'Skill — это директория с совместимым с Claude файлом `SKILL.md` (YAML-фронтматтер + тело). OneHub Design расширяет формат пространством имён `od:` (`mode`, `preview`, `design_system`, `inputs`, …), чтобы один и тот же артефакт можно было использовать как внутри OneHub Design, так и обычным агентом, например Claude Code, Codex, openclaw или hermes. Обнаружение следует цепочке приоритетов, поэтому проекты могут переопределять свои собственные навыки.',
  ...
  'useEverywhere.section.skills.snippet1': 'Минимальный SKILL.md (совместимый с Claude front matter + дополнения OneHub Design)',
  ...
  'entry.githubStarAria': 'Поставить OneHub Design звезду на GitHub',
  ...
  'newproj.locationDefault': 'Проекты OneHub Design',
  ...
  'socialShare.openDesignSection': 'Поделиться OneHub Design',
  'socialShare.openDesignTitle': 'OneHub Design на GitHub',
  'socialShare.openDesignText': 'OneHub Design — это рабочее пространство с открытым исходным кодом для создания, редактирования, развёртывания и передачи дизайн-артефактов.',
  ...
  'socialShare.projectText': 'Создано с помощью OneHub Design: {title}. Посмотрите развёрнутый артефакт и поставьте звезду репозиторию: {repo}',
  'socialShare.projectCopyText': 'Создано с помощью OneHub Design: {title}\n{url}\nРепозиторий OneHub Design: {repo}',
  ...
  'chat.activeFilePlaceholder': 'Попросите OneHub Design изменить {file}...',
  ...
  'chat.mode.design.solves': 'Используйте его, когда OneHub Design должен сгенерировать файлы, обновить workspace или превратить бриф в мультимодальные deliverables.',
  ...
  'preview.shareTextDefault': 'Шаблон OneHub Design: {title}',
  ...
  'preview.errorBody': 'Не удалось получить HTML примера. Убедитесь, что OneHub Design запущен, и повторите попытку.',
  ...
  'designFiles.usefulInfoTip7': 'Нравится OneHub Design? Поставьте звезду на GitHub.',
  ...
  'assistant.shareToOpenDesign': 'Поделиться в OneHub Design',
  ...
  'pet.tabBuiltInHint': 'Подобранные питомцы в комплекте OneHub Design — выберите и забирайте.',
  ...
  'pet.codexBundledTitle': 'Поставляется с OneHub Design — загрузка не нужна.',
  ...
  'settings.projectLocationsDescription': 'Добавьте рабочие базы, которые могут содержать несколько папок проектов OneHub Design. Новые проекты сохраняются как папка внутри выбранной базы.',
  ...
  'settings.customInstructionsHint': 'Постоянные инструкции, которым OneHub Design должен следовать в каждом чате. Сохраняйте факты, предпочтения и контекст проекта в виде памяти.',
  ...
  'settings.memoryStarterProjectDesc': 'OneHub Design v0.5 — редактор дизайна с управлением через чат',
  ...
  'updater.availableBody': 'OneHub Design {version} доступен. Он будет загружен перед открытием установщика.',
  ...
  'updater.installerOpenBody': 'Установщик открыт. OneHub Design закрывается, чтобы вы могли завершить обновление.',
  ...
  'updater.quitButton': 'Закрыть OneHub Design',
  'updater.quitFailedBody': 'Установщик открыт, но OneHub Design не удалось закрыть. Закройте OneHub Design перед заменой приложения.',
  'updater.quitFailedTitle': 'Не удалось закрыть',
  'updater.quitting': 'Закрытие...',
  'updater.ready': 'Обновление готово',
  'updater.readyGeneric': 'Новая версия готова. OneHub Design закроется и откроет установщик.',
  'updater.readyVersion': 'OneHub Design {version} готов. OneHub Design закроется и откроет установщик.',
  ...
  'dsManager.createBody': 'Обучите OneHub Design вашему бренду, продукту, коду, ресурсам и дизайн-референсам.',
  ...
  'settings.customInstructionsDesc': 'Фиксированные инструкции, которым OneHub Design следует в каждом чате. Это не сохранённые воспоминания; используйте Память для фактов, предпочтений и контекста проекта.',
