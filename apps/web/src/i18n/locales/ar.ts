...
export const ar: Dict = {
  ...
  'chat.amrCard.switchBody': 'بدِّل إلى خدمة نماذج AMR الرسمية من OneHub Design — لا حاجة لإعداد مفتاح API. بعد تسجيل الدخول والتفويض والشحن، ستُعاد محاولة هذه المهمة تلقائيًا.',
  ...
  'settings.welcomeTitle': 'مرحبًا بك في OneHub Design',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'ابدأ من ملخص',
  'settings.onboardingCreateBody': 'صِف الموقع أو التطبيق أو العرض التقديمي أو الصورة أو الفيديو الذي تريده. سيُنشئ OneHub Design مشروعًا ويُبقي العمل قابلاً للتحرير.',
  ...
  'settings.onboardingMemoryCalloutBody': 'تُغذّي هذه الإجابات ملف الذاكرة الخاص بك. يعيد OneHub Design استخدامه في كل مهمة — ويستمر في التعلّم أثناء عملك.',
  ...
  'settings.onboardingCloudTitle': 'تسجيل الدخول إلى OneHub Design',
  'settings.onboardingCloudBody': 'سجّل الدخول وابدأ التصميم فورًا باستخدام الذكاء الاصطناعي السحابي، دون أي إعداد معقّد.',
  'settings.onboardingCloudSignIn': 'تسجيل الدخول إلى OneHub Design Cloud',
  ...
  'settings.onboardingGateTooltipAmr': 'الخطوات التالية تعمل بالذكاء الاصطناعي — سجّل الدخول إلى OneHub Design AMR للمتابعة.',
  ...
  'settings.agentInstall.pathHint': 'إذا ثبّتّ CLI باستخدام npm أو Homebrew وما زال يظهر كغير مثبت، فتأكد من أن مجلد bin للأداة موجود في PATH الذي يرثه daemon الخاص بـ OneHub Design (قد يختلف PATH بين Terminal وتطبيقات GUI على macOS). راجع QUICKSTART.md (قسم "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'افتح رابط التثبيت أو الوثائق للوكيل الذي تفضله.',
  'settings.agentInstall.stepAuth': 'أكمِل المصادقة في CLI الخاص بالمزوّد (تسجيل الدخول أو إضافة بيانات اعتماد API) قبل العودة إلى OneHub Design.',
  ...
  'settings.mcpServerHint': 'كشف OneHub Design كخادم MCP لوكيل البرمجة الخاص بك.',
  ...
  'settings.privacyHint': 'البيانات التي تتم مشاركتها مع فريق OneHub Design',
  'settings.privacyConsentKicker': 'ساعدنا في تحسين OneHub Design',
  'settings.privacyConsentLead': 'يمكن لـ OneHub Design مشاركة بيانات الاستخدام مع فريقنا لمساعدتنا على التحسين. يشمل ذلك:',
  ...
  'settings.mcpHint': 'اسمح لوكلاء البرمجة (Cursor، Claude Code، VS Code…) بقراءة مشاريع OneHub Design الخاصة بك مباشرةً.',
  'settings.mcpDaemonError': 'تعذّر الوصول إلى الـ daemon المحلي لتحديد مسارات التثبيت ({error}). تأكد من أن OneHub Design قيد التشغيل، ثم أعد فتح هذه اللوحة.',
  ...
  'settings.mcpCapabilityDefault': 'الاعتماد افتراضيًا على المشروع والملف المفتوحَين في OneHub Design، حتى تتمكن من قول "ابنِ هذا في تطبيقي" دون إعادة تحديد التصميم المقصود.',
  'settings.mcpRunningNote': 'يجب أن يكون OneHub Design قيد التشغيل حتى تنجح استدعاءات أدوات MCP. إذا بدأت تشغيل وكيل البرمجة قبل فتح OneHub Design، فأعد تشغيل الـ Agent ليتمكن من الوصول إلى الـ daemon النشط.',
  ...
  'entry.discordAria': 'انضم إلى Discord الخاص بـ OneHub Design',
  'entry.discordAriaWithOnline': 'انضم إلى Discord الخاص بـ OneHub Design - {online}',
  ...
  'homeHero.chip.createPluginHint': 'أنشئ إضافة OneHub Design قابلة لإعادة الاستخدام وأضِفها إلى إضافاتي.',
  ...
  'handoff.promptIntro': 'المتابعة من مجلد مشروع OneHub Design المحلي هذا:',
  ...
  'pluginsHome.subtitle': 'سير عمل OneHub Design جاهز للاستخدام ومرفق بهذا التشغيل. اختر واحدًا لتحميل موجّه بدء، أو تصفّح السجل للمزيد.',
  'pluginsHome.browseRegistry': 'تصفح السجل',
  'pluginsHome.count': '{filtered} من {total}',
  'pluginsHome.loadingCatalog': 'جارٍ تحميل الكتالوج…',
  'pluginsHome.emptyCatalog': 'الكتالوج فارغ. تأتي الإضافات المُجمَّعة مع OneHub Design ومن المفترض أن تظهر هنا تلقائيًا — جرّب إعادة تشغيل الـ daemon إذا استمرت هذه المشكلة.',
  ...
  'pluginCard.contributeAria': 'المساهمة بـ {title} في OneHub Design',
  'pluginCard.contributeTitle': 'المساهمة بالإضافة في OneHub Design عبر طلب سحب (PR)',
  ...
  'integrations.lede': 'اربط الأنظمة الخارجية، وأدخِل أدوات MCP إلى حلقة الـ Agent الخاصة بك، واستخدم OneHub Design من بيئات تطوير وبرامج نصية وعمليات أتمتة أخرى.',
  ...
  'mcpClient.daemonError': 'تعذّر الوصول إلى الخدمة المحلية. تأكّد من أن OneHub Design قيد التشغيل، ثم أعِد فتح هذه اللوحة.',
  'mcpClient.saveFailed': 'فشل الحفظ. تحقّق من أن الخدمة قيد التشغيل وحاول مرة أخرى.',
  'useEverywhere.modalAria': 'استخدم OneHub Design في كل مكان',
  'useEverywhere.modalTitle': 'استخدم OneHub Design في كل مكان',
  'useEverywhere.modalSubtitle': 'أدرِج OneHub Design في أي IDE أو Agent أو سكربت — CLI وHTTP وMCP وSkills. استخدم “Copy guide for an agent” والصقه في Claude Code أو Codex أو Cursor أو openclaw أو hermes لإعداد كل شيء.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — حزم `SKILL.md` جاهزة للاستخدام (متوافقة مع Claude) يمكن لأي Agent موجود مسبقًا على الـ PATH استدعاؤها دون الحاجة إلى OneHub Design على الإطلاق.',
  ...
  'useEverywhere.section.cli.heading': 'تشغيل OneHub Design من أي shell',
  ...
  'useEverywhere.section.mcp.heading': 'اجعل OneHub Design متاحًا كخادم MCP لأي coding agent',
  'useEverywhere.section.mcp.intro': 'يأتي OneHub Design مع خادم Model Context Protocol (`od mcp`) يتيح لأي عميل يدعم MCP — Cursor، Claude Code، Antigravity، VS Code Copilot Chat، openclaw، hermes — اكتشاف أدوات OneHub Design (سرد المهارات، عرض المعاينات، توليد الوسائط، تشغيل الإضافات) دون استخدام الـ shell يدويًا. ينشر الـ daemon مقتطف تثبيت جاهزًا للصق عبر `GET /api/mcp/install-info` لكل عميل رئيسي.',
  ...
  'useEverywhere.section.mcp.footer': 'في تطبيق OneHub Design، افتح الإعدادات → التكاملات لنسخ أمر تثبيت خاص بكل عميل (Cursor، Claude Code، Antigravity، VS Code) بدلًا من تحرير JSON يدويًا.',
  ...
  'useEverywhere.section.skills.heading': 'مهارات Skills جاهزة للاستخدام لأي Agent — حتى دون تشغيل OneHub Design',
  'useEverywhere.section.skills.intro': 'المهارة هي دليل يحتوي على `SKILL.md` متوافق مع Claude (مقدّمة YAML + متن). يوسّع OneHub Design التنسيق بفضاء الأسماء `od:` (`mode`، `preview`، `design_system`، `inputs`، …) بحيث يمكن استخدام المخرَج نفسه داخل OneHub Design ومن قِبل Agent عادي مثل Claude Code أو Codex أو openclaw أو hermes. يتّبع الاكتشاف سلسلة أولوية بحيث يمكن للمشاريع تجاوز مهاراتها الخاصة.',
  ...
  'useEverywhere.section.skills.snippet1': 'SKILL.md بحدّه الأدنى (front matter متوافق مع Claude + إضافات OneHub Design)',
  ...
  'entry.githubStarAria': 'منح OneHub Design نجمة على GitHub',
  ...
  'newproj.locationDefault': 'مشاريع OneHub Design',
  ...
  'socialShare.openDesignSection': 'مشاركة OneHub Design',
  'socialShare.openDesignTitle': 'OneHub Design على GitHub',
  'socialShare.openDesignText': 'OneHub Design هي مساحة عمل مفتوحة المصدر لإنشاء عناصر التصميم وتحريرها ونشرها وتسليمها.',
  ...
  'socialShare.projectText': 'تم الإنشاء باستخدام OneHub Design: {title}. اعرض العنصر المنشور وامنح نجمة للمستودع: {repo}',
  'socialShare.projectCopyText': 'تم الإنشاء باستخدام OneHub Design: {title}\n{url}\nمستودع OneHub Design: {repo}',
  ...
  'chat.activeFilePlaceholder': 'اطلب من OneHub Design تعديل {file}...',
  ...
  'chat.mode.design.solves': 'استخدمه عندما تريد من OneHub Design إنشاء ملفات، تحديث مساحة العمل، أو تحويل موجز إلى مخرجات متعددة الوسائط جاهزة.',
  ...
  'preview.errorBody': 'فشل جلب HTML الخاص بالمثال. تأكد من تشغيل OneHub Design ثم أعد المحاولة.',
  ...
  'designFiles.usefulInfoTip7': 'أعجبك OneHub Design؟ امنحنا نجمة على GitHub.',
  ...
  'assistant.shareToOpenDesign': 'المشاركة على OneHub Design',
  ...
  'pet.tabBuiltIn': 'مدمج',
  'pet.tabBuiltInHint': 'رفقاء منتقون مدمجون مع OneHub Design - اختر واحداً وتبنَّه.',
  ...
  'pet.codexBundledTitle': 'يأتي مع OneHub Design - لا حاجة للتحميل.',
  ...
  'settings.projectLocationsDescription': 'أضف قواعد عمل يمكن أن تحتوي على عدة مجلدات مشاريع OneHub Design. تُحفظ المشاريع الجديدة كمجلد داخل القاعدة المحددة.',
  ...
  'settings.memoryStarterProjectDesc': 'OneHub Design v0.5 — محرر تصميم يعمل بالمحادثة',
  ...
  'updater.availableBody': 'OneHub Design {version} متوفر. سيتم تنزيله قبل فتح المثبت.',
  ...
  'updater.installerOpenBody': 'المثبت مفتوح. يتم الآن إنهاء OneHub Design لتتمكن من إكمال التحديث.',
  ...
  'updater.quitButton': 'إنهاء OneHub Design',
  'updater.quitFailedBody': 'المثبت مفتوح، لكن تعذر إنهاء OneHub Design. أغلق OneHub Design قبل استبدال التطبيق.',
  'updater.quitFailedTitle': 'تعذر الإنهاء',
  'updater.quitting': 'جارٍ الإنهاء...',
  'updater.ready': 'التحديث جاهز',
  'updater.readyGeneric': 'إصدار جديد جاهز. سيتم إغلاق OneHub Design وفتح المثبت.',
  'updater.readyVersion': 'OneHub Design {version} جاهز. سيتم إغلاق OneHub Design وفتح المثبت.',
  ...
  'dsManager.createBody': 'علّم OneHub Design علامتك التجارية ومنتجك وكودك وأصولك ومراجع التصميم الخاصة بك.',
  ...
  'settings.customInstructionsDesc': 'تعليمات ثابتة يتبعها OneHub Design في كل محادثة. هذه ليست ذكريات محفوظة؛ استخدم الذاكرة للحقائق والتفضيلات وسياق المشروع.',
