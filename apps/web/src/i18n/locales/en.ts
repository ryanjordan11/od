...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to OneHub Design\'s official AMR model service — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'settings.welcomeTitle': 'Welcome to OneHub Design',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. OneHub Design will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. OneHub Design reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingCloudTitle': 'Sign in to OneHub Design',
  'settings.onboardingCloudBody': 'Sign in to start designing with cloud AI right away — no complex setup required.',
  'settings.onboardingCloudSignIn': 'Sign in to OneHub Design Cloud',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to OneHub Design AMR to continue.',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the OneHub Design daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to OneHub Design.',
  ...
  'settings.mcpServerHint': 'Expose OneHub Design as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the OneHub Design team',
  'settings.privacyConsentKicker': 'Help us improve OneHub Design',
  'settings.privacyConsentLead': 'OneHub Design can share usage data with our team to help us improve. This includes:',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS Code…) read your OneHub Design projects directly.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure OneHub Design is running, then reopen this panel.',
  ...
  'settings.mcpCapabilityDefault': 'Default to the project and file you have open in OneHub Design, so you can say "build this in my app" without re-stating which design.',
  'settings.mcpRunningNote': 'OneHub Design must be running for MCP tool calls to succeed. If you started your coding agent before opening OneHub Design, restart the agent so it can reach the live daemon.',
  ...
  'entry.discordAria': 'Join the OneHub Design Discord',
  'entry.discordAriaWithOnline': 'Join the OneHub Design Discord - {online}',
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable OneHub Design plugin and add it to My plugins.',
  ...
  'handoff.promptIntro': 'Continue from this local OneHub Design project folder:',
  ...
  'designSystemPicker.noPreview': 'No preview page. OneHub Design Systems to view the full preview.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use OneHub Design workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with OneHub Design and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to OneHub Design',
  'pluginCard.contributeTitle': 'Contribute plugin to OneHub Design with a pull request',
  ...
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use OneHub Design from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure OneHub Design is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use OneHub Design everywhere',
  'useEverywhere.modalTitle': 'Use OneHub Design everywhere',
  'useEverywhere.modalSubtitle': 'Drop OneHub Design into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'OneHub Design works wherever your agent works',
  'useEverywhere.section.overview.intro': 'OneHub Design is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires OneHub Design as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without OneHub Design at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive OneHub Design from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose OneHub Design as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'OneHub Design ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover OneHub Design tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the OneHub Design app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without OneHub Design running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). OneHub Design extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside OneHub Design and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + OneHub Design extras)',
  ...
  'entry.githubStarAria': 'Star OneHub Design on GitHub',
  ...
  'newproj.locationDefault': 'OneHub Design projects',
  ...
  'socialShare.openDesignSection': 'Share OneHub Design',
  'socialShare.openDesignTitle': 'OneHub Design on GitHub',
  'socialShare.openDesignText': 'OneHub Design is an open-source workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectText': 'Built with OneHub Design: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with OneHub Design: {title}\n{url}\nOneHub Design repo: {repo}',
  ...
  'chat.activeFilePlaceholder': 'Ask OneHub Design to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want OneHub Design to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure OneHub Design is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.usefulInfoTip7': 'Enjoying OneHub Design? Star us on GitHub.',
  ...
  'assistant.shareToOpenDesign': 'Share to OneHub Design',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with OneHub Design — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with OneHub Design — no download needed.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple OneHub Design project folders. New projects are saved as one folder inside the selected base.',
  ...
  'updater.availableBody': 'OneHub Design {version} is available. It will download before the installer can open.',
  ...
  'updater.installerOpenBody': 'The installer is open. OneHub Design is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit OneHub Design',
  'updater.quitFailedBody': 'The installer is open, but OneHub Design could not quit. Quit OneHub Design before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. OneHub Design will close and open the installer.',
  'updater.readyVersion': 'OneHub Design {version} is ready. OneHub Design will close and open the installer.',
  ...
  'dsManager.createBody': 'Teach OneHub Design your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions OneHub Design follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach OneHub Design your design systems — extract one from a website, then apply it in any chat.',
