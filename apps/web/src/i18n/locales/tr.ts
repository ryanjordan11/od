...
export const tr: Dict = {
  ...
  'chat.amrCard.switchBody': 'OneHub Design\'ın resmi AMR model hizmetine geçin — API anahtarı yapılandırması gerekmez. Oturum açma, yetkilendirme ve bakiye yükleme sonrası bu çalıştırma otomatik olarak yeniden denenir.',
  ...
  'settings.welcomeTitle': 'OneHub Design’a hoş geldiniz',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Bir brief ile başlayın',
  'settings.onboardingCreateBody': 'İstediğiniz siteyi, uygulamayı, sunumu, görseli veya videoyu tanımlayın. OneHub Design bir proje oluşturacak ve çalışmayı düzenlenebilir tutacak.',
  ...
  'settings.onboardingMemoryCalloutBody': 'Bu yanıtlar Bellek profilinizin temelini oluşturur. OneHub Design bunu her görevde yeniden kullanır ve siz çalışırken öğrenmeye devam eder.',
  ...
  'settings.onboardingCloudTitle': 'OneHub Design’a giriş yap',
  'settings.onboardingCloudBody': 'Giriş yap ve bulut yapay zekâsıyla hemen tasarlamaya başla — karmaşık kurulum gerekmez.',
  'settings.onboardingCloudSignIn': 'OneHub Design Cloud’a giriş yap',
  ...
  'settings.onboardingGateTooltipAmr': 'Sonraki adımlar yapay zekâ ile çalışır — devam etmek için OneHub Design AMR’ye giriş yapın.',
  ...
  'settings.agentInstall.pathHint': 'Bir CLI\'yi npm veya Homebrew ile kurduysan ancak hâlâ kurulu değil olarak görünüyorsa, aracın bin dizininin OneHub Design daemon\'unun devraldığı PATH içinde olduğundan emin ol (macOS\'te Terminal ve GUI uygulamalarının PATH\'i farklı olabilir). QUICKSTART.md içindeki "Local agent CLI and PATH" bölümüne bak.',
  'settings.agentInstall.stepOpenLinks': 'Tercih ettiğin ajan için Yükle veya Dokümanlar bağlantısını aç.',
  'settings.agentInstall.stepAuth': 'OneHub Design\'a dönmeden önce sağlayıcı CLI\'sinde kimlik doğrulaması yap (oturum aç veya API kimlik bilgileri ekle).',
  ...
  'settings.mcpServerHint': 'OneHub Design\'ı kodlama ajanınız için MCP sunucusu olarak yayınlayın.',
  ...
  'settings.privacyHint': 'OneHub Design ekibiyle hangi veriler paylaşılır',
  'settings.privacyConsentKicker': 'OneHub Design\'ı geliştirmemize yardımcı olun',
  'settings.privacyConsentLead': 'OneHub Design, geliştirmemize yardımcı olmak için kullanım verilerini ekibimizle paylaşabilir. Buna şunlar dahildir:',
  ...
  'settings.mcpHint': 'Kodlama agent\'larının (Cursor, Claude Code, VS Code…) OneHub Design projelerinizi doğrudan okumasına izin verin.',
  'settings.mcpDaemonError': 'Kurulum yollarını çözümlemek için yerel daemon\'a ulaşılamadı ({error}). OneHub Design\'ın çalıştığından emin olun, ardından bu paneli yeniden açın.',
  ...
  'settings.mcpCapabilityDefault': 'OneHub Design\'da açık olan projeyi ve dosyayı varsayılan olarak kullanın; böylece hangi tasarım olduğunu yeniden belirtmeden "bunu uygulamamda oluştur" diyebilirsiniz.',
  'settings.mcpRunningNote': 'MCP araç çağrılarının başarılı olması için OneHub Design\'ın çalışıyor olması gerekir. Kodlama agent\'ınızı OneHub Design\'ı açmadan önce başlattıysanız, canlı daemon\'a ulaşabilmesi için agent\'ı yeniden başlatın.',
  ...
  'entry.discordAria': 'OneHub Design Discord\'una katılın',
  'entry.discordAriaWithOnline': 'OneHub Design Discord\'una katılın - {online}',
  ...
  'homeHero.chip.createPluginHint': 'Yeniden kullanılabilir bir OneHub Design plugin\'i oluşturun ve Plugin\'lerim\'e ekleyin.',
  ...
  'handoff.promptIntro': 'Bu yerel OneHub Design proje klasöründen devam edin:',
  ...
  'pluginsHome.subtitle': 'Bu çalışma zamanıyla birlikte gelen, kullanıma hazır OneHub Design iş akışları. Başlangıç istemi yüklemek için birini seçin veya daha fazlası için kayıt defterine göz atın.',
  ...
  'pluginsHome.emptyCatalog': 'Katalog boş. Paketlenmiş eklentiler OneHub Design ile birlikte gelir ve buraya otomatik olarak görünmelidir — bu durum devam ederse daemon\'u yeniden başlatmayı deneyin.',
  ...
  'pluginCard.contributeAria': '{title} öğesini OneHub Design\'a katkı olarak ekle',
  'pluginCard.contributeTitle': 'Plugin\'i pull request ile OneHub Design\'a katkı olarak ekle',
  ...
  'integrations.lede': 'Harici sistemleri bağlayın, MCP araçlarını agent döngünüze dahil edin ve OneHub Design\'ı diğer IDE\'ler, betikler ve otomasyonlardan kullanın.',
  ...
  'mcpClient.daemonError': 'Yerel daemon\'a ulaşılamadı. OneHub Design\'ın çalıştığından emin olun, ardından bu paneli yeniden açın.',
  'mcpClient.saveFailed': 'Kaydetme başarısız oldu. Daemon\'ın çalıştığını kontrol edip tekrar deneyin.',
  'useEverywhere.modalAria': 'OneHub Design\'ı her yerde kullanın',
  'useEverywhere.modalTitle': 'OneHub Design\'ı her yerde kullanın',
  'useEverywhere.modalSubtitle': 'OneHub Design\'ı herhangi bir IDE\'ye, Agent\'a veya betiğe bırakın — CLI, HTTP, MCP ve Beceriler. Her şeyi kurmak için "Bir agent için kılavuzu kopyala"yı kullanın ve Claude Code, Codex, Cursor, openclaw veya hermes\'e yapıştırın.',
  ...
  'useEverywhere.section.overview.heading': 'OneHub Design, agent\'ınızın çalıştığı her yerde çalışır',
  'useEverywhere.section.overview.intro': 'OneHub Design bir pencereden fazlasıdır — yerel ayrıcalıklı bir daemon (`od`) ile birlikte bir Beceriler + Tasarım Sistemleri + Atoms kayıt defteridir. Makinenizde çalışmaya başladığında, herhangi bir kod agent\'ı (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, kendi betiğiniz) dört değiştirilebilir yüzey aracılığıyla üretimleri yönetebilir, projeleri inceleyebilir ve tasarım çıktıları üretebilir.',
  'useEverywhere.section.overview.bullet1': 'CLI — başsız betikler, CI ve kabuk otomasyonu için `od <command>`.',
  'useEverywhere.section.overview.bullet2': 'MCP sunucusu — OneHub Design\'ı bir Model Context Protocol sunucusu olarak bağlar, böylece MCP destekli herhangi bir agent becerileri listeleyebilir, senaryoları çalıştırabilir ve çıktıları okuyabilir.',
  ...
  'useEverywhere.section.overview.bullet4': 'Beceriler — PATH\'inizde zaten bulunan herhangi bir agent\'ın OneHub Design olmadan çağırabileceği eklenebilir `SKILL.md` paketleri (Claude uyumlu).',
  ...
  'useEverywhere.section.cli.heading': 'OneHub Design\'ı herhangi bir kabuktan yönetin',
  ...
  'useEverywhere.section.mcp.heading': 'OneHub Design\'ı herhangi bir kodlama agent\'ına MCP sunucusu olarak sun',
  'useEverywhere.section.mcp.intro': 'OneHub Design, MCP destekli herhangi bir istemcinin — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — OneHub Design araçlarını (becerileri listele, önizlemeleri oluştur, medya üret, eklentileri çalıştır) manuel olarak kabuk açmadan keşfetmesini sağlayan bir Model Context Protocol sunucusu (`od mcp`) ile gelir. Daemon, her büyük istemci için `GET /api/mcp/install-info` aracılığıyla yapıştırmaya hazır bir kurulum parçacığı yayınlar.',
  ...
  'useEverywhere.section.mcp.footer': 'OneHub Design uygulamasında, JSON\'u elle düzenlemek yerine istemciye özel bir kurulum komutu (Cursor, Claude Code, Antigravity, VS Code) kopyalamak için Ayarlar → Entegrasyonlar\'ı açın.',
  ...
  'useEverywhere.section.skills.heading': 'Herhangi bir agent için eklenebilir Beceriler — OneHub Design çalışmıyor olsa bile',
  'useEverywhere.section.skills.intro': 'Bir Beceri, Claude uyumlu bir `SKILL.md` (YAML ön bilgisi + gövde) içeren bir dizindir. OneHub Design, formatı `od:` ad alanıyla (`mode`, `preview`, `design_system`, `inputs`, …) genişletir, böylece aynı çıktı hem OneHub Design içinde hem de Claude Code, Codex, openclaw veya hermes gibi sade bir agent tarafından kullanılabilir. Keşif, projelerin kendi becerilerini geçersiz kılabilmesi için bir öncelik zincirini izler.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude uyumlu ön bilgi + OneHub Design ekstraları)',
  ...
  'entry.githubStarAria': 'OneHub Design’a GitHub üzerinde yıldız ver',
  ...
  'newproj.locationDefault': 'OneHub Design projeleri',
  ...
  'socialShare.openDesignSection': 'OneHub Design\'ı paylaş',
  'socialShare.openDesignTitle': 'GitHub\'da OneHub Design',
  'socialShare.openDesignText': 'OneHub Design; tasarım yapıtları oluşturmak, düzenlemek, dağıtmak ve devretmek için açık kaynaklı bir çalışma alanıdır.',
  ...
  'socialShare.projectText': 'OneHub Design ile oluşturuldu: {title}. Dağıtılan yapıtı görüntüleyin ve depoya yıldız verin: {repo}',
  'socialShare.projectCopyText': 'OneHub Design ile oluşturuldu: {title}\n{url}\nOneHub Design deposu: {repo}',
  ...
  'chat.activeFilePlaceholder': 'OneHub Design\'dan {file} dosyasını değiştirmesini isteyin...',
  ...
  'chat.mode.design.solves': 'OneHub Design’ın dosya üretmesini, workspace’i güncellemesini veya brief’i çok modlu deliverable’lara dönüştürmesini istediğinizde kullanın.',
  ...
  'preview.shareTextDefault': 'OneHub Design şablonu: {title}',
  ...
  'preview.errorBody': 'Örnek HTML\'i alınamadı. OneHub Design\'ın çalıştığından emin olup tekrar deneyin.',
  ...
  'assistant.shareToOpenDesign': 'OneHub Design\'a paylaş',
  ...
  'pet.tabBuiltInHint': 'OneHub Design ile gelen seçili dostlar — birini seç ve sahiplen.',
  ...
  'pet.codexBundledTitle': 'OneHub Design ile birlikte gelir — indirme gerekmez.',
  ...
  'settings.projectLocationsDescription': 'Birden fazla OneHub Design proje klasörü içerebilen çalışma tabanları ekleyin. Yeni projeler seçilen tabanın içinde bir klasör olarak kaydedilir.',
  ...
  'settings.memoryStarterProjectDesc': 'OneHub Design v0.5 — sohbet odaklı tasarım editörü',
  ...
  'updater.availableBody': 'OneHub Design {version} mevcut. Yükleyici açılmadan önce indirilecek.',
  ...
  'updater.installerOpenBody': 'Yükleyici açık. Güncellemeyi tamamlayabilmeniz için OneHub Design kapatılıyor.',
  ...
  'updater.quitButton': 'OneHub Design’dan çık',
  'updater.quitFailedBody': 'Yükleyici açık, ancak OneHub Design kapatılamadı. Uygulamayı değiştirmeden önce OneHub Design’dan çıkın.',
  'updater.quitFailedTitle': 'Çıkılamadı',
  'updater.quitting': 'Çıkılıyor...',
  'updater.ready': 'Güncelleme hazır',
  'updater.readyGeneric': 'Yeni bir sürüm hazır. OneHub Design kapanıp yükleyiciyi açacak.',
  'updater.readyVersion': 'OneHub Design {version} hazır. OneHub Design kapanıp yükleyiciyi açacak.',
  ...
  'dsManager.createBody': 'OneHub Design\'a markanızı, ürününüzü, kodunuzu, varlıklarınızı ve tasarım referanslarınızı öğretin.',
  ...
  'settings.customInstructionsDesc': 'OneHub Design\'ın her sohbette izlediği sabit yönergeler. Bunlar kayıtlı bellekler değildir; gerçekler, tercihler ve proje bağlamı için Bellek\'i kullanın.',
