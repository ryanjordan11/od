...
export const it: Dict = {
  ...
  'chat.amrCard.switchBody': 'Passa al servizio modelli AMR ufficiale di OneHub Design — nessuna chiave API da configurare. Dopo accesso, autorizzazione e ricarica, questa esecuzione verrà ritentata automaticamente.',
  ...
  'settings.welcomeTitle': 'Ti diamo il benvenuto in OneHub Design',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Inizia da un brief',
  'settings.onboardingCreateBody': 'Descrivi il sito, l\'app, la presentazione, l\'immagine o il video che desideri. OneHub Design creerà un progetto e manterrà il lavoro modificabile.',
  ...
  'settings.onboardingMemoryCalloutBody': 'Queste risposte costituiscono la base del tuo profilo di Memoria. OneHub Design la riutilizza in ogni attività e continua a imparare mentre lavori.',
  ...
  'settings.onboardingGateTooltipAmr': 'I passaggi successivi vengono eseguiti tramite IA — accedi a OneHub Design AMR per continuare.',
  ...
  'settings.agentInstall.pathHint': 'Se hai installato una CLI con npm o Homebrew e appare ancora come non installata, verifica che la cartella bin dello strumento sia nel PATH ereditato dal daemon OneHub Design (Terminale e app GUI possono differire su macOS). Vedi QUICKSTART.md (sezione "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Apri Installa o Documentazione per l\'agente desiderato.',
  'settings.agentInstall.stepAuth': 'Autenticati con la CLI del provider (login o aggiunta delle credenziali API) prima di tornare in OneHub Design.',
  ...
  'settings.mcpServerHint': 'Esponi OneHub Design come server MCP per il tuo agente di codice.',
  ...
  'settings.privacyHint': 'Quali dati vengono condivisi con il team di OneHub Design',
  'settings.privacyConsentKicker': 'Aiutaci a migliorare OneHub Design',
  'settings.privacyConsentLead': 'OneHub Design può condividere dati di utilizzo con il nostro team per aiutarci a migliorare. Questo include:',
  ...
  'settings.mcpHint': 'Consenti agli agent di coding (Cursor, Claude Code, VS Code…) di leggere direttamente i tuoi progetti OneHub Design.',
  'settings.mcpDaemonError': 'Impossibile raggiungere il daemon locale per risolvere i percorsi di installazione ({error}). Assicurati che OneHub Design sia in esecuzione, quindi riapri questo pannello.',
  ...
  'settings.mcpCapabilityDefault': 'Utilizzare per impostazione predefinita il progetto e il file che hai aperto in OneHub Design, così puoi dire "build this in my app" senza dover ripetere quale design.',
  'settings.mcpRunningNote': 'OneHub Design deve essere in esecuzione affinché le chiamate agli strumenti MCP abbiano successo. Se hai avviato il tuo coding agent prima di aprire OneHub Design, riavvia l\'agent in modo che possa raggiungere il daemon attivo.',
  ...
  'entry.discordAria': 'Unisciti al Discord di OneHub Design',
  'entry.discordAriaWithOnline': 'Unisciti al Discord di OneHub Design - {online}',
  ...
  'homeHero.chip.createPluginHint': 'Crea un plugin OneHub Design riutilizzabile e aggiungilo a I miei plugin.',
  ...
  'handoff.promptIntro': 'Continua da questa cartella di progetto locale di OneHub Design:',
  ...
  'pluginsHome.subtitle': 'Workflow di OneHub Design pronti all\'uso inclusi in questo runtime. Scegline uno per caricare un prompt iniziale oppure esplora il registry per altro.',
  ...
  'pluginsHome.emptyCatalog': 'Il catalogo è vuoto. I plugin inclusi sono forniti con OneHub Design e dovrebbero comparire qui automaticamente — prova a riavviare il daemon se il problema persiste.',
  ...
  'pluginCard.contributeAria': 'Contribuisci con {title} a OneHub Design',
  'pluginCard.contributeTitle': 'Contribuisci con il plugin a OneHub Design tramite una pull request',
  ...
  'integrations.lede': 'Collega sistemi esterni, porta gli strumenti MCP nel loop del tuo agent e usa OneHub Design da altri IDE, script e automazioni.',
  ...
  'mcpClient.daemonError': 'Impossibile raggiungere il daemon locale. Assicurati che OneHub Design sia in esecuzione, quindi riapri questo pannello.',
  'mcpClient.saveFailed': 'Salvataggio non riuscito. Verifica che il daemon sia in esecuzione e riprova.',
  'useEverywhere.modalAria': 'Usa OneHub Design ovunque',
  'useEverywhere.modalTitle': 'Usa OneHub Design ovunque',
  'useEverywhere.modalSubtitle': 'Integra OneHub Design in qualsiasi IDE, agent o script — CLI, HTTP, MCP e Skill. Usa “Copia la guida per un agent” e incollala in Claude Code, Codex, Cursor, openclaw o hermes per configurare tutto.',
  ...
  'useEverywhere.section.overview.heading': 'OneHub Design funziona ovunque lavori il tuo agent',
  'useEverywhere.section.overview.intro': 'OneHub Design è molto più di una finestra — è un daemon locale con privilegi (`od`) più un registro di Skill + Design System + Atoms. Una volta in esecuzione sulla tua macchina, qualsiasi agent di codice (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, un tuo script) può avviare generazioni, ispezionare progetti e produrre artefatti di design attraverso quattro interfacce intercambiabili.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` per script headless, CI e automazione da shell.',
  'useEverywhere.section.overview.bullet2': 'Server MCP — collega OneHub Design come server Model Context Protocol così che qualsiasi agent compatibile con MCP possa elencare skill, eseguire scenari e leggere artefatti.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skill — pacchetti `SKILL.md` pronti all\'uso (compatibili con Claude) che qualsiasi agent già presente nel tuo PATH può invocare senza OneHub Design.',
  ...
  'useEverywhere.section.cli.heading': 'Controlla OneHub Design da qualsiasi shell',
  ...
  'useEverywhere.section.mcp.heading': 'Esponi OneHub Design come server MCP a qualsiasi coding agent',
  'useEverywhere.section.mcp.intro': 'OneHub Design include un server Model Context Protocol (`od mcp`) che consente a qualsiasi client compatibile con MCP — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — di scoprire gli strumenti di OneHub Design (elenca skill, genera anteprime, genera media, esegui plugin) senza ricorrere manualmente alla shell. Il daemon pubblica uno snippet di installazione pronto da incollare tramite `GET /api/mcp/install-info` per ogni client principale.',
  ...
  'useEverywhere.section.mcp.footer': 'Nell\'app OneHub Design, apri Impostazioni → Integrazioni per copiare un comando di installazione specifico per il client (Cursor, Claude Code, Antigravity, VS Code) invece di modificare il JSON manualmente.',
  ...
  'useEverywhere.section.skills.heading': 'Skill pronte all\'uso per qualsiasi agent — anche senza OneHub Design in esecuzione',
  'useEverywhere.section.skills.intro': 'Una Skill è una directory con un file `SKILL.md` compatibile con Claude (front-matter YAML + corpo). OneHub Design estende il formato con il namespace `od:` (`mode`, `preview`, `design_system`, `inputs`, …) così che lo stesso artefatto possa essere usato sia all\'interno di OneHub Design sia da un agent standard come Claude Code, Codex, openclaw o hermes. Il rilevamento segue una catena di precedenza così che i progetti possano sovrascrivere le proprie skill.',
  ...
  'useEverywhere.section.skills.snippet1': 'SKILL.md minimale (front matter compatibile con Claude + extra di OneHub Design)',
  ...
  'entry.githubStarAria': 'Assegna una star a OneHub Design su GitHub',
  ...
  'newproj.locationDefault': 'Progetti OneHub Design',
  ...
  'socialShare.openDesignSection': 'Condividi OneHub Design',
  'socialShare.openDesignTitle': 'OneHub Design su GitHub',
  'socialShare.openDesignText': 'OneHub Design è uno spazio di lavoro open-source per creare, modificare, distribuire e consegnare artifact di design.',
  ...
  'socialShare.projectText': 'Creato con OneHub Design: {title}. Visualizza l\'artifact distribuito e metti una stella al repo: {repo}',
  'socialShare.projectCopyText': 'Creato con OneHub Design: {title}\n{url}\nRepo di OneHub Design: {repo}',
  ...
  'chat.activeFilePlaceholder': 'Chiedi a OneHub Design di modificare {file}...',
  ...
  'chat.mode.design.solves': 'Usala quando vuoi che OneHub Design generi file, aggiorni il workspace o trasformi un brief in deliverable multimodali.',
  ...
  'preview.shareTextDefault': 'Template OneHub Design: {title}',
  ...
  'preview.errorBody': 'Il caricamento dell\'HTML dell\'esempio è fallito. Verifica che OneHub Design sia in esecuzione e riprova.',
  ...
  'designFiles.usefulInfoTip7': 'Ti piace OneHub Design? Lascia una stella su GitHub.',
  ...
  'assistant.shareToOpenDesign': 'Condividi su OneHub Design',
  ...
  'pet.tabBuiltInHint': 'Compagni forniti con OneHub Design — scegline uno e adottalo.',
  ...
  'pet.codexBundledTitle': 'Fornito con OneHub Design — nessun download necessario.',
  ...
  'settings.projectLocationsDescription': 'Aggiungi basi di lavoro che possono contenere più cartelle di progetti OneHub Design. I nuovi progetti vengono salvati come una cartella nella base selezionata.',
  ...
  'settings.memoryStarterProjectDesc': 'OneHub Design v0.5 — editor di design guidato da chat',
  ...
  'updater.availableBody': 'OneHub Design {version} è disponibile. Verrà scaricato prima di aprire il programma di installazione.',
  ...
  'updater.installerOpenBody': 'Il programma di installazione è aperto. OneHub Design si sta chiudendo per consentirti di completare l’aggiornamento.',
  ...
  'updater.payloadReadyGeneric': 'A new OneHub Design update is ready. OneHub Design will close and restart automatically.',
  'updater.payloadReadyVersion': 'OneHub Design {version} is ready. OneHub Design will close and restart automatically.',
  'updater.quitButton': 'Esci da OneHub Design',
  'updater.quitFailedBody': 'Il programma di installazione è aperto, ma OneHub Design non è riuscito a uscire. Esci da OneHub Design prima di sostituire l’app.',
  'updater.quitFailedTitle': 'Impossibile uscire',
  'updater.quitting': 'Uscita...',
  'updater.ready': 'Aggiornamento pronto',
  'updater.readyGeneric': 'È pronta una nuova versione. OneHub Design si chiuderà e aprirà il programma di installazione.',
  'updater.readyVersion': 'OneHub Design {version} è pronto. OneHub Design si chiuderà e aprirà il programma di installazione.',
  ...
  'dsManager.createBody': 'Insegna a OneHub Design il tuo brand, prodotto, codice, asset e riferimenti di design.',
  ...
  'settings.customInstructionsDesc': 'Istruzioni fisse che OneHub Design segue in ogni chat. Non sono memorie salvate; usa Memoria per fatti, preferenze e contesto del progetto.',
