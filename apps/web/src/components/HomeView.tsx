    ...
    <div className="home-view" data-testid="home-view" ref={homeViewRef}>
      ...
      <section className="home-free-agents">
        ...
        <div className="home-free-agents__cards">
          <a
            className="home-free-agents__card"
            href="https://opencode.ai"
            target="_blank"
            rel="noopener noreferrer"
          >
            <span className="home-free-agents__card-name">OpenCode</span>
            <span className="home-free-agents__card-desc">
              Open-source agent CLI — fast, free, works great.
            </span>
          </a>
          <a
            className="home-free-agents__card"
            href="https://github.com/kilocode/cli"
            target="_blank"
            rel="noopener noreferrer"
          >
            <span className="home-free-agents__card-name">Kilo</span>
            <span className="home-free-agents__card-desc">
              Also free and really good — give it a try.
            </span>
          </a>
        </div>
      </section>
