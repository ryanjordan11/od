// Trigger prompt for the post-completion "Share to OneHub Design" submission
...
export const SHARE_TO_COMMUNITY_PROMPT = [
  'Package the work I just finished in this project as an OneHub Design plugin so I can install it into My plugins and open a PR to the OneHub Design community catalog.',
  '',
  ...
  '- **OneHub Design PR** — opens a draft PR against \`nexu-io/open-design\` for the community catalog.',
  '',
