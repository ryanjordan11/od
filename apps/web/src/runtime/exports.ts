...
export function buildDesignManifestContent(opts: {
  ...
  const title = opts.title || 'OneHub Design artifact';
...
- Keep generated product UI free of OneHub Design chrome, preview labels, or design-process annotations.
...
- Do not keep prototype-only annotations, frame labels, or OneHub Design chrome in the production UI.
